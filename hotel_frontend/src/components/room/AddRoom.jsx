...
import { FiHome, FiDollarSign, FiPlus, FiX } from "react-icons/fi"
				...
				<div className="w-full max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
					...
					<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
						<div>
							...
							<p className="text-gray-600 mt-1">Create a new room for your hotel inventory</p>
						</div>
						<Link 
    ...
    />
							...
							<div className="flex flex-col sm:flex-row gap-3 sm:justify-end pt-4 border-t border-gray-200">
								...
								<button
									...
									disabled={!newRoom.roomType || !newRoom.roomPrice || !newRoom.photo}
								>
